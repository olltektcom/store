...
@push('scripts')
    <script type="text/x-template" id="book-slots-template">
        ...
        <div class="book-slots">
            <label>{{ $title ?? __('fashion::app.shop.products.book-an-appointment') }} :</label>

            <div class="control-group-container">
                <div class="control-group date" :class="[errors.has('booking[date]') ? 'has-error' : '']">
                    <date @onChange="dateSelected($event)">
                        <input type="text" v-validate="'required'" name="booking[date]" class="control" data-vv-as="&quot;{{ __('fashion::app.shop.products.date') }}&quot;"/>
                    </date>
                ...
                <div class="control-group slots" :class="[errors.has('booking[slot]') ? 'has-error' : '']">
                    <select v-validate="'required'" name="booking[slot]" class="control" data-vv-as="&quot;{{ __('fashion::app.shop.products.slot') }}&quot;">

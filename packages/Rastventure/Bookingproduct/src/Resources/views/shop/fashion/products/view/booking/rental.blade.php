...
@push('scripts')
    <script type="text/x-template" id="rental-slots-template">
        <div class="book-slots">
            <h3>{{ __('fashion::app.shop.products.rent-an-item') }}</h3>

            <div v-if="renting_type == 'daily_hourly'">
                <div class="control-group">
                    <label>{{ __('fashion::app.shop.products.choose-rent-option') }}</label>
                    ...
                    <span class="radio">
                        ...
                        {{ __('fashion::app.shop.products.daily-basis') }}
                    </span>
                    ...
                    <span class="radio">
                        ...
                        {{ __('fashion::app.shop.products.hourly-basis') }}
                    </span>
            ...
            <div v-if="renting_type != 'daily' && sub_renting_type == 'hourly'">
                ...
                <div>
                    <label>{{ __('fashion::app.shop.products.select-slot') }}</label>

                    <div class="control-group-container">
                        <div class="control-group date" :class="[errors.has('booking[date]') ? 'has-error' : '']">
                            <date @onChange="dateSelected($event)">
                                <input type="text" v-validate="'required'" name="booking[date]" class="control" data-vv-as="&quot;{{ __('fashion::app.shop.products.date') }}&quot;" placeholder="{{ __('fashion::app.shop.products.select-date') }}" data-min-date="today"/>
                            </date>
                        ...
                        <div class="control-group slots" :class="[errors.has('booking[slot]') ? 'has-error' : '']">
                            <select v-validate="'required'" name="booking[slot]" v-model="selected_slot" class="control" data-vv-as="&quot;{{ __('fashion::app.shop.products.slot') }}&quot;">
                                <option value="">{{ __('fashion::app.shop.products.select-time-slot') }}</option>
                ...
                <div v-if="slots[selected_slot] && slots[selected_slot]['slots'].length">
                    <label>{{ __('fashion::app.shop.products.select-rent-time') }}</label>

                    <div class="control-group-container">
                        <div class="control-group slots" :class="[errors.has('booking[slot][from]') ? 'has-error' : '']">
                            <select v-validate="'required'" name="booking[slot][from]" v-model="slot_from" class="control" data-vv-as="&quot;{{ __('fashion::app.shop.products.slot') }}&quot;">
                                <option value="">{{ __('fashion::app.shop.products.select-time-slot') }}</option>
                        ...
                        <div class="control-group slots" :class="[errors.has('booking[slot][to]') ? 'has-error' : '']">
                            <select v-validate="'required'" name="booking[slot][to]" class="control" data-vv-as="&quot;{{ __('fashion::app.shop.products.slot') }}&quot;">
                                <option value="">{{ __('fashion::app.shop.products.select-time-slot') }}</option>
            ...
            <div v-else>
                <label>{{ __('fashion::app.shop.products.select-date') }}</label>

                <div class="control-group-container">
                    <div class="control-group date" :class="[errors.has('booking[date_from]') ? 'has-error' : '']">
                        <date @onChange="dateSelected($event)">
                            <input type="text" v-validate="'required|date_format:yyyy-MM-dd|before_or_equal:date_to'" name="booking[date_from]" v-model="date_from" class="control" data-vv-as="&quot;{{ __('fashion::app.shop.products.from') }}&quot;" placeholder="{{ __('fashion::app.shop.products.from') }}" ref="date_from" data-min-date="today"/>
                        </date>
                    ...
                    <div class="control-group date" :class="[errors.has('booking[date_to]') ? 'has-error' : '']">
                        <date @onChange="dateSelected($event)">
                            <input type="text" v-validate="'required|date_format:yyyy-MM-dd|after_or_equal:date_from'" name="booking[date_to]" v-model="date_to" class="control" data-vv-as="&quot;{{ __('fashion::app.shop.products.to') }}&quot;" placeholder="{{ __('fashion::app.shop.products.to') }}" ref="date_to" data-min-date="today"/>
                        </date>

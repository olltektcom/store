<div class="booking-info-row">
    ...
    <span class="title">
        ...
        {{ __('fashion::app.shop.products.slot-duration-in-minutes', ['minutes' => $bookingProduct->table_slot->duration]) }}
    </span>
</div>
...
<div class="booking-info-row">
    <span class="icon bp-slot-icon"></span>
    <span class="title">
        {{ __('fashion::app.shop.products.today-availability') }}
    </span>
    ...
    <div class="toggle" @click="showDaysAvailability = ! showDaysAvailability">
        {{ __('fashion::app.shop.products.slots-for-all-days') }}
                    ...
                    <tr>
                        ...
                        <td>
                            @if ($day['slots'] && count($day['slots']))
                                ...
                                @endforeach
                            @else
                                <span class="text-danger">{{ __('fashion::app.shop.products.closed') }}</span>
                            @endif
                        </td>
                    </tr>
                @endforeach
...
@include ('fashion::shop.products.view.booking.slots', [
        'bookingProduct' => $bookingProduct,
        'title' => __('fashion::app.shop.products.book-a-table')
    ])

<div class="control-group">
    <label>{{ __('fashion::app.shop.products.special-notes') }}</label>

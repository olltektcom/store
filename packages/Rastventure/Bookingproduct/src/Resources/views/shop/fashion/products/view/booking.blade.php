                ...
                <div class="booking-information">
                    ...
                    @if ($bookingProduct->location != '')
                        <div class="booking-info-row">
                            ...
                            <span class="title">{{ __('fashion::app.shop.products.location') }}</span>
                    ...
                    @include ('fashion::shop.products.view.booking.' . $bookingProduct->type, ['bookingProduct' => $bookingProduct])

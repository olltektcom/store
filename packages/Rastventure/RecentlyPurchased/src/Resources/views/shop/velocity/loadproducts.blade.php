@if(core()->getConfigData('recently_purchased.settings.settings.status')==1)
    ...
    <?php $products = $productRepository->getNewProducts(); ?>
    ...
    @push('scripts')
        <script type="text/javascript" id="sales-booster-popup-products">@php echo json_encode($products_list); @endphp</script>
    @endpush
@endif
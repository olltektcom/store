...
@push('scripts')
    ...
    <script type="text/x-template" id="checkout-template">
        <div id="checkout" class="checkout-process">
            ...
            <div class="col-right" v-show="current_step != 4">
                <item-summary-section></item-summary-section>
                <summary-section :key="summeryComponentKey"></summary-section>
            </div>
        </div>
    </script>
    ...
    <script>
        ...
        Vue.component('item-summary-section', {
            inject: ['$validator'],
            template: '#item-summary-template',
        })
    </script>

    <script type="text/x-template" id="item-summary-template">
        <div class="row">
            <div class="col-md-12 order-summary">
                <h3>{{ __('fashion::app.shop.checkout.yourOrder') }}</h3>
                <div class="cart-table cart-table--sm">
                    ...
                    @foreach ($cart->items as $key => $item)
                        <div class="table-row">
                            ...
                            <div class="name">
                                <a href="{{ route('shop.productOrCategory.index', $item->product->url_key) }}">{{ $item->product->name }}</a>
                            </div>

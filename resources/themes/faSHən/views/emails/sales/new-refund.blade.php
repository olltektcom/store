    ...
    <div style="padding: 30px;">
        ...
        <div style="font-size: 16px;color: #242424;line-height: 30px;float: right;width: 40%;margin-top: 20px;">
            ...
            @php
                ...
                <span style="float: right;">
                    {{ core()->currency($refund->gst_total_amount/2) }}
                </span>
            </div>
                             <div>
                ...
                <span style="float: right;">
                    {{ core()->currency($refund->gst_total_amount) }}
                </span>
            </div>
            ...
            <div style="font-weight: bold">
                ...
                <span style="float: right;">
                    {{ core()->formatPrice($refund->grand_total+$refund->gst_total_amount, $refund->order_currency_code) }}
                </span>
            </div>
        </div>

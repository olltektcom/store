...
<div class="filter-row">
    <div class="row">
        <div class="col-xs-8 col-sm-7 col-lg-5 col-left">
            ...
            <div class="form-label">{{ __('shop::app.products.sort-by') }}</div>
        ...
        <div class="col-xs-4 col-sm-3 col-lg-5 col-right">
            <div class="form-label">{{ __('shop::app.products.show') }}:</div>
            <div class="select-wrapper-sm">
                <select onchange="window.location.href = this.value" class="form-control input-sm">
...
<!-- Total -->
<div class="items-total">{{ __('shop::app.products.pager-info', ['showing' => $products->firstItem() . '-' . $products->lastItem(), 'total' => $products->total()]) }}</div>
<!-- /Total -->
